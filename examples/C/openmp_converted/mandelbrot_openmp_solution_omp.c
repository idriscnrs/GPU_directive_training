...
#pragma omp target teams map(from:picture[first*width:num_elements])
    {
    #pragma acc loop 
#pragma omp loop
...
// Code was translated using: /home/very/bin/acc2mp -async=nowait -specify-language=C -generate-report mandelbrot_openmp_solution.c
