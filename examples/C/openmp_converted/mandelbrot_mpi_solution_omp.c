...
#pragma omp target data map(from:picture[0:num_elements])
{
...
// Code was translated using: /home/very/bin/acc2mp -async=nowait -specify-language=C -generate-report mandelbrot_mpi_solution.c
