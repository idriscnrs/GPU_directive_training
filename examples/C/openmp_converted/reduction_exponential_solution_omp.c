...
#pragma omp target teams loop reduction(+:sum) reduction(min:dmin)\
            reduction(max:dmax)
...
// Code was translated using: /home/very/bin/acc2mp -async=nowait -specify-language=C -generate-report reduction_exponential_solution.c
