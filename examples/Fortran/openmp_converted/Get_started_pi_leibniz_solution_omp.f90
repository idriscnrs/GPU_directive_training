...
!$omp target teams loop reduction(+:pi)
    do i = 0, steps
...
! Code was translated using: intel-application-migration-tool-for-openacc-to-openmp Get_started_pi_leibniz_solution.f90
